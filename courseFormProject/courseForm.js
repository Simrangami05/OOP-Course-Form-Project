...
(function () {
  ...
  Display.prototype.addCustomer = function (customer) {
    ...
    div.innerHTML = `<div class="card text-left display-flex">
     <img src="cust-${random}.jpg" class="card-img-top" width="250px" alt="">
     <div class="card-body">
      <!-- customer name -->
      <h6 class="text-capitalize "><span class="badge badge-warning mr-2">Name</span><span id="customer-name">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : &nbsp&nbsp ${customer.name}</span></h6>
      <!-- end of customer name -->
      <!-- customer name -->
      <h6 class="text-capitalize my-3"><span class="badge badge-success mr-2">Course</span><span id="customer-course">
      &nbsp&nbsp : &nbsp ${customer.course}
       </span></h6>
      <!-- end of customer name -->
      <!-- customer name -->
      <h6 class="text-capitalize"><span class="badge badge-danger mr-2">Author</span><span id="course-author">&nbsp&nbsp : &nbsp ${customer.author}</span></h6>
      <!-- end of customer name -->
     </div>
    </div>`;
